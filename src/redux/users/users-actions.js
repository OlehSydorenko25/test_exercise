...
export const changePhoneNumberRequest = createAction(
  'users/changePhoneNumberRequest',
);
export const changePhoneNumberSuccess = createAction(
  'users/changePhoneNumberSuccess',
);
export const changePhoneNumberError = createAction(
  'users/changePhoneNumberError',
);

export const changeLocationRequest = createAction(
  'users/changeLocationRequest',
);
export const changeLocationSuccess = createAction(
  'users/changeLocationSuccess',
);
...
export const changeDateBirthRequest = createAction(
  'users/changeDateBirthRequest',
);
export const changeDateBirthSuccess = createAction(
  'users/changeDateBirthSuccess',
);
...
export const changeState = createAction('users/changeState');
